...
const ALL_TYPES: Array<ResourceType | "All Types"> = [
  "All Types",
  "Lecture Hall",
  "Lab",
  "Meeting Room",
...
const ALL_STATUS: Array<"All Status" | ResourceStatus> = [
  "All Status",
  "ACTIVE",
  "OUT_OF_SERVICE",
];
...
export default function ResourcesPage() {
  ...
  const [statusFilter, setStatusFilter] = useState<(typeof ALL_STATUS)[number]>(
    "All Status",
  );
    ...
    <div>
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        ...
        <select
          value={statusFilter}
          onChange={(e) =>
            setStatusFilter(e.target.value as (typeof ALL_STATUS)[number])
          }
          className="px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
        >
